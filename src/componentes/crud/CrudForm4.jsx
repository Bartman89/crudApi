...
function CrudForm4({equipos, addEquipo, idEdit, editEquipo, setIdEdit, mayorId}) {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} >
      ...
      <input onChange={handleChange} className='mx-1' type="text" name='nombre' placeholder='Ingresa el equipo.' value={formData.nombre} required/>
      <label className='mx-1' htmlFor="pais">Pais:</label>
      <input onChange={handleChange} className='mx-1' type="text" name="pais" placeholder='Ingresa el pais.' value={formData.pais} required/>
      <input disabled={desabilitado} className='btn btn-success mx-1' type="submit" value="Enviar" />
